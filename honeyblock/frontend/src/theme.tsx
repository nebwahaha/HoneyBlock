...
// ★ Default — VS Code Dark Modern surfaces with Material amber accent
export const obsidianTheme: Theme = {
  ...
  brand: '#ffc107',
  navText: '#7a7a7a',
  navActiveBg: 'rgba(255,193,7,0.10)',
  navActiveText: '#ffc107',
  cardBg: '#252526',
  cardBorder: '#2b2b2b',
  cardHoverBg: '#2a2d2e',
  cardHoverBorder: '#3a3a3a',
  iconAccentBg: 'rgba(255,193,7,0.12)',
  iconAccent: '#ffc107',
  heading: '#ffffff',
  textPrimary: '#cccccc',
  ...
  amber: '#ffc107',
  orange: '#ffd54f',
  blockBtn: 'rgba(248,81,73,0.13)',
  blockBtnText: '#f85149',
  blockBtnBorder: 'rgba(248,81,73,0.30)',
  unblockBtn: 'rgba(115,201,145,0.10)',
  unblockBtnText: '#73c991',
  unblockBtnBorder: 'rgba(115,201,145,0.28)',
  ...
  barCursor: 'rgba(255,193,7,0.10)',
  sessionClosed: '#6a6a6a',
  tcpTunnel: '#3794ff',
  fileDownload: '#f85149',
  blockStatusActiveBg: 'rgba(248,81,73,0.07)',
  blockStatusInactiveBg: '#252526',
  notifItemBg: '#1f1f1f',
  toggleActiveBorder: '#ffc107',
  toggleActiveText: '#ffc107',
  toggleInactiveBorder: '#2b2b2b',
  toggleInactiveText: '#6a6a6a',
  toggleDisabledBg: '#2a2d2e',
  messageBgError: 'rgba(248,81,73,0.07)',
  messageBgSuccess: 'rgba(115,201,145,0.07)',
  pieStroke: '#1f1f1f',
  btnBg: '#252526',
  btnBorder: '#2b2b2b',
  btnText: '#9d9d9d',
